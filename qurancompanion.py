...
def set_lang(uid, lang): user_languages[uid] = lang; _save()
def clean(t): return re.sub(r'<[^>]+>', '', t).strip()

# ── MOTIVATIONAL MESSAGES ──────────────────────────────────────────────────────
# One list. Each message has a key per language.
# When user picks a language, they get that exact message in their language.
MESSAGES = [
    {
        ...
        "Hindi":      "अल्लाह जानता है तुम्हारे दिल में क्या है। हर आंसू, हर रात — वो सब देखता है। जो कुछ भी तुमसे गुजरता है वो बेकार नहीं जाता।",
    ...
    {
        "English":    "Your rizq is written. Your relief is coming — it was written before you were even born. Do your best and leave the rest to Allah.",
        "Arabic":     "رزقُكَ مكتوب. فرجُكَ آتٍ — كُتِبَ قبل أن تُولَد. افعلْ ما بوسعِك وتوكَّل على الله.",
        "French":     "Ton rizq est écrit. Ton soulagement arrive — il était écrit avant même ta naissance. Fais de ton mieux et laisse le reste à Allah.",
        "Russian":    "Твой ризк написан. Твоё облегчение придёт — оно было записано ещё до твоего рождения. Делай что можешь и остальное оставь Аллаху.",
        "German":     "Dein Rizq ist geschrieben. Deine Erleichterung kommt — sie wurde geschrieben, bevor du geboren wurdest. Tu dein Bestes und überlasse den Rest Allah.",
        "Spanish":    "Tu rizq está escrito. Tu alivio viene — estaba escrito antes de que nacieras. Haz lo mejor que puedas y deja el resto a Allah.",
        "Italian":    "Il tuo rizq è scritto. Il tuo sollievo sta arrivando — era scritto prima ancora che tu nascessi. Fai del tuo meglio e lascia il resto ad Allah.",
        "Turkish":    "Rızkın yazılmış. Rahatlaman geliyor — sen doğmadan önce yazılmıştı. Elinden geleni yap, gerisini Allah'a bırak.",
        "Urdu":       "تمہارا رزق لکھا ہوا ہے۔ تمہاری راحت آنے والی ہے — پیدائش سے پہلے لکھی گئی تھی۔ بہترین کوشش کرو اور باقی اللہ پر چھوڑ دو۔",
        "Hindi":      "तुम्हारा रिज्क लिखा हुआ है। राहत आने वाली है — तुम्हारे पैदा होने से पहले लिखी गई थी। बेहतरीन कोशिश करो और बाकी अल्लाह पर छोड़ दो।",
        "Bengali":    "তোমার রিজক লেখা আছে। তোমার স্বস্তি আসছে — তুমি জন্মানোর আগেই লেখা হয়েছিল। সর্বোত্তম চেষ্টা করো এবং বাকিটা আল্লাহর উপর ছেড়ে দাও।",
        "Indonesian": "Rezekimu sudah tertulis. Kelapanganmu akan datang — sudah ditulis sebelum kamu lahir. Lakukan yang terbaik dan serahkan sisanya kepada Allah.",
        "Malay":      "Rezkimu sudah ditulis. Kelegaanmu akan datang — ditulis sebelum kamu dilahirkan. Lakukan yang terbaik dan serahkan selebihnya kepada Allah.",
        "Persian":    "رزقت نوشته شده. آسایشت در راه است — قبل از تولدت نوشته شده بود. بهترین تلاشت را بکن و بقیه را به الله بسپار.",
        "Bosnian":    "Tvoj rizk je zapisan. Olakšanje dolazi — zapisano je prije nego što si se rodio. Uradi što možeš i ostalo prepusti Allahu.",
        "Dutch":      "Jouw rizq is opgeschreven. Jouw verlichting komt — het was opgeschreven voordat je zelfs maar geboren was. Doe je best en laat de rest aan Allah over.",
        "Swedish":    "Din rizq är skriven. Din lättnad kommer — den skrevs innan du ens var född. Gör ditt bästa och lämna resten till Allah.",
    },
    {
    ...
    },
    {
        ...
        "Urdu":       "کبھی کبھی اللہ جواب میں دیر کرتا ہے — تمہیں رد کرنے کے لیے نہیں، بلکہ تمہاری حفاظت کے لیے۔ اس کی منصوبہ بندی ہمیشہ بہتر ہے۔",
        "Hindi":      "कभी-कभी अल्लाह जवाब में देर करता है — तुम्हें रद्द करने के लिए नहीं, بلکہ تمہاری حفاظت کے لیے۔ उसकी योजना हमेशा बेहतर है।",
...
DUAS = [
    {
        ...
        "translations": {
            ...
            "Hindi": "हे अल्लाह, मैं तुझसे दुःख, उदासी, कमजोरी, आलस्य, कायरता, कंजूसी और कर्ज के बोझ से शरण मांगता हूं।",
            "Bengali": "হে আল্লাহ, আমি তোমার কাছে দুঃখ, কষ্ট, দুর্বলতা, অলসতা, কাপুরুষতা, কৃপণতা এবং ঋণের বোঝা থেকে আশ্রয় চাই।",
            "Indonesian": "Ya Allah, aku berlindung kepada-Mu dari kesedihan, duka, kelemahan, kemalasan, pengecut, kikir dan beban hutang.",
            "Malay": "Ya Allah, aku berlindung kepada-Mu daripada kesedihan, kelemahan, kemalasan, pengecut, kebakhilan dan beban hutang.",
            "Persian": "خداوندا، از غم، اندوه، ضعف، تنبلی، ترس، بخل و سنگینی بدهی به تو پناه می‌برم.",
            "Bosnian": "Allahu, utječem Ti se od brige, tuge, slabosti, lijenosti, kukavičluka, škrtosti i tereta duga.",
            "Dutch": "O Allah, ik zoek toevlucht bij U voor verdriet, zwakheid, luiheid, lafheid, gierigheid en schuldenlast.",
            "Swedish": "O Allah, jag söker skydd hos Dig mot sorg, svaghet, lättja, feghet, snålhet och skuldebörda.",
        }
    },
    {
        ...
        "translations": {
            ...
            "Hindi": "तेरे سिवा कोई उपास्य नहीं, तू पवित्र है, मैं अत्याचारियों में से था।",
    ...
    },
    {
        ...
        "translations": {
            ...
            "Hindi": "हे मेरे प्रभु, उन पर दया कर जैسे उन्होंने मुझे बचपन में पाला।",
...
def fetch_verse(s, a, lang):
    ...
    for tid in ids:
        try:
            r = requests.get(f"https://api.quran.com/api/v4/verses/by_key/{s}:{a}?translations={tid}&fields=text_uthmani", timeout=10)
...
def fetch_surah_info(n):
    try:
        ...
        return {'name': d.get('name_simple', ''), 'arabic_name': d.get('name_arabic', ''),
                'meaning': d.get('translated_name', {}).get('name', ''),
                'verses': d.get('verses_count', 0), 'revelation': d.get('revelation_place', '').capitalize(), 'num': n}
    except: return None
...
def fmt_dua(d, lang):
    trans = d['translations'].get(lang, d['translations'].get('English', ''))
    t = f"*{d['title']}*\n\n{d['arabic']}\n\n_{trans}_\n\n*Source:* {d['source']}\n\n{SEP}\n{FOOTER}"
    return t
...
async def cmd_restart(u: Update, c: ContextTypes.DEFAULT_TYPE):
    ...
    await u.message.reply_text(
        ...
        parse_mode='Markdown',
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Choose Language", callback_data="choose_lang")]]))
